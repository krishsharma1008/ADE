...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@combyne/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@combyne/adapter-utils").TranscriptEntry[];
