...
import type { AdapterEnvironmentTestResult } from "@combyne/shared";
...
} from "@combyne/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@combyne/adapter-cursor-local";
...
const DEFAULT_TASK_DESCRIPTION = `Setup yourself as the CEO. Use the ceo persona found here: [https://github.com/combyneai/companies/blob/main/default/ceo/AGENTS.md](https://github.com/combyneai/companies/blob/main/default/ceo/AGENTS.md)
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <HintIcon text="Combyne works best if you create a new folder for your agents to keep their memories and stay organized. Create a new folder and put the path here." />
                        </div>
