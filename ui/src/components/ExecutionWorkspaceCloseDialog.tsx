...
import type { ExecutionWorkspace } from "@combyne/shared";
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="break-words">
            ...
            artifacts. Combyne keeps the workspace record and issue history, but removes it from active workspace views.
          </DialogDescription>
        </DialogHeader>
