...
import { buildProjectMentionHref, parseProjectMentionHref } from "@combyne/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("combyne-project-mention-chip");
      ...
      link.classList.add("combyne-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative combyne-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("combyne-mdxeditor", !bordered && "combyne-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "combyne-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
