...
import { AGENT_ADAPTER_TYPES } from "@combyne/shared";
import type {
  Agent,
...
// Canonical type lives in @combyne/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@combyne/adapter-utils";
...
const ENABLED_ADAPTER_TYPES = new Set(["claude_local", "codex_local", "opencode_local", "cursor", "gemini_local", "pi_local"]);
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        COMBYNE_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
