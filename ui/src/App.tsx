...
import { CliAuthPage as CliAuth } from "./pages/CliAuth";
import { NotFoundPage as NotFound } from "./pages/NotFound";
    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          No instance admin exists yet. Run this command in your Combyne environment to generate
          the first admin invite URL:
        </p>
        <pre className="mt-4 overflow-x-auto rounded-md border border-border bg-muted/30 p-3 text-xs">
{`pnpm combyne auth bootstrap-ceo`}
        </pre>
      </div>
    </div>
  );
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="workspaces/:workspaceId" element={<ExecutionWorkspaceDetail />} />
