...
import type { ExecutionWorkspace, Project, ProjectWorkspace } from "@combyne/shared";
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(18rem,0.95fr)]">
          <div className="space-y-6">
            <div className="rounded-2xl border border-border bg-card p-5">
              <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
                <div className="space-y-2">
                  ...
                  <p className="max-w-2xl text-sm text-muted-foreground">
                    Configure the concrete runtime workspace that Combyne reuses for this issue flow. These settings stay
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                <Field label="Provision command" hint="Runs when Combyne prepares this execution workspace">
                  <textarea
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <DetailRow label="Working dir">
                {workspace.cwd ? <><MonoValue value={workspace.cwd} copy /><FileActions filePath={workspace.cwd} className="ml-1" /></> : "None"}
              </DetailRow>
