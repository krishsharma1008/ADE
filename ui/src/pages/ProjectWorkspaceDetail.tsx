...
import { isUuidLike, type ProjectWorkspace } from "@combyne/shared";
...
const SOURCE_TYPE_OPTIONS: Array<{ value: ProjectWorkspaceSourceType; label: string; description: string }> = [
  { value: "local_path", label: "Local git checkout", description: "A local path Combyne can use directly." },
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm text-muted-foreground">
                  Configure the concrete workspace Combyne attaches to this project. These values drive per-workspace
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <DetailRow label="Local path">
              ...
              {workspace.cwd && <FileActions filePath={workspace.cwd} className="ml-1" />}
            </DetailRow>
