...
import { isUuidLike, normalizeAgentUrlKey } from "@combyne/shared";
...
export const agentsApi = {
  ...
  updatePermissions: (
    id: string,
    data: { canCreateAgents?: boolean; canAssignTasks?: boolean; taskAssignmentScope?: "none" | "reports" | "company" },
    companyId?: string,
  ) =>
