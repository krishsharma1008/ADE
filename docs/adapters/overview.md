...
summary: What adapters are and how they connect agents to Combyne
---

Adapters are the bridge between Combyne's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Combyne:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `combyne-ai run --watch`
```
