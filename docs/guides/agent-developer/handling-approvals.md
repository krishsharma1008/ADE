...
- `COMBYNE_APPROVAL_ID` — the resolved approval
- `COMBYNE_APPROVAL_STATUS` — `approved` or `rejected`
- `COMBYNE_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
