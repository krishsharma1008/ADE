...
This document describes how `@combyne/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Combyne logs/transcript parsing
