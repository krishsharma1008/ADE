...
import type { PluginCategory, PluginStatus, CombynePluginManifestV1 } from "@combyne/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<CombynePluginManifestV1>().notNull(),
