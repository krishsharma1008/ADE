...
// ---------------------------------------------------------------------------
// Manifest sub-types -- nested declarations within CombynePluginManifestV1
// ---------------------------------------------------------------------------

/**
 * Declares a scheduled job a plugin can run.
 *
 * @see PLUGIN_SPEC.md S17 -- Scheduled Jobs
 */
 ...
 *
 * @see PLUGIN_SPEC.md S18 -- Webhooks
 */
 ...
 *
 * @see PLUGIN_SPEC.md S11 -- Agent Tools
 */
 ...
 *
 * @see PLUGIN_SPEC.md S19 -- UI Extension Model
 */
...
/**
 * Lower-bound semver requirement for the Combyne host.
 *
 ...
 * See PLUGIN_SPEC.md S10.1 for the normative definition.
 */
export interface CombynePluginManifestV1 {
   ...
   */
  minimumCombyneVersion?: PluginMinimumHostVersion;
 ...
 * See PLUGIN_SPEC.md S21.3 for the schema definition.
 */
 ...
 *
 * @see PLUGIN_SPEC.md S21.3 -- `plugin_state`
 */
