/**
 * `definePlugin` — the top-level helper for authoring a Combyne plugin.
 *
...
// ---------------------------------------------------------------------------
// CombynePlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface CombynePlugin {
 ...
 * @returns A sealed `CombynePlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@combyne/plugin-sdk";
