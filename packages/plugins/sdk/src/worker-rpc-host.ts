...
import type { CombynePlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@combyne/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: CombynePluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@combyne/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
