/**
 * `@combyne/plugin-sdk/ui` — Combyne plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@combyne/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@combyne/plugin-sdk/ui";
 *
