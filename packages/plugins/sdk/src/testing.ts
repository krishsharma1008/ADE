...
function requireCapability(manifest: CombynePluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Combyne server runtime.
 */
