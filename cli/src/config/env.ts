...
const JWT_SECRET_ENV_KEY = "COMBYNE_AGENT_JWT_SECRET";
...
function renderEnvFile(entries: Record<string, string>) {
  const lines = [
    "# Combyne environment variables",
    "# Generated by `combyneai onboard`",
...
export function loadCombyneEnvFile(configPath?: string): void {
