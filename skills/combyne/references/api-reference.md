# Combyne API Reference

Detailed reference for the Combyne control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Combyne Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "combyne-mobile",
    "cwd": "/Users/me/combyne-mobile",
    "repoUrl": "https://github.com/acme/combyne-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `combyne-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
