...
- installed adapter list for this Combyne instance
...
## 8. New Skill: `combyne-create-agent`

Create new skill directory:

- `skills/combyne-create-agent/SKILL.md`
...
Also update `skills/combyne/SKILL.md` to reference this skill for hiring workflows.
...
- `combyne-create-agent` skill + docs updates
