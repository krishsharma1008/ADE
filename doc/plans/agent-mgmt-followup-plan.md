...
- `skills/combyne/SKILL.md` and `skills/combyne/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/combyne-create-agent/SKILL.md`
