...
import { models as codexFallbackModels } from "@combyne/adapter-codex-local";
import { models as cursorFallbackModels } from "@combyne/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@combyne/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.COMBYNE_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.COMBYNE_OPENCODE_COMMAND = "__combyne_missing_opencode_command__";
