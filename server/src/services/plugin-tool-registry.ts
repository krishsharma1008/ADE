...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@combyne/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: CombynePluginManifestV1, pluginDbId?: string): void;
