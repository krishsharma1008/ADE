 ...
 */
import type { CompanyPortabilityManifest } from "@combyne/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Combyne](https://combyne.ai)");
  lines.push("");
