/**
 * PluginEventBus — typed in-process event bus for the Combyne plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@combyne/shared";
import type { PluginEvent, EventFilter } from "@combyne/plugin-sdk";
